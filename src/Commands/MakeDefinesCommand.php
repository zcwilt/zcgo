...
use Zcgo\Lib\LangDefinesBaseCommand;

class MakeDefinesCommand extends LangDefinesBaseCommand
{
    /**
     * @var string
     */
    protected static $defaultName = 'lang-defines:convert';
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->output->writeln('<info>Command finished successfully</info>');
        exit(0);
    }
     ...
     * @return bool
     */
    protected function canSkipCurrentToken($token): bool
    {
     ...
     * @param OutputInterface $output
     */
    protected function doVerboseOutput(string $output): void
    {
